...
/**
 * Clase de implementacion de entidad de la tabla SDB_BGN_DEPARTAMENTO de Gis
 * @author datatools
 */
@Entity
@Table(name=Constants.TABLA_DEPARTAMENTO)
@NamedQuery(name=Constants.DEPARTAMENTO_FINDALL, query=Constants.SELECT_DEPARTAMENTO)
@NamedQuery(name=Constants.DEPARTAMENTO_FINDVALUE, query=Constants.SELECT_DEPARTAMENTO_DEPTO)
